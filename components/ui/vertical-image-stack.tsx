...
// 21st.dev VerticalImageStack — copied verbatim; the ONLY functional change is
// that the hardcoded demo images are replaced by the `items` prop (plus
// optional initialIndex / onIndexChange so the caller can show the current
// item's title). All motion values, sizes, dots, counter and hint are original.
...
export function VerticalImageStack({
  ...
  // Let the caller mirror the current index (e.g. to show the item's title).
  useEffect(() => {
