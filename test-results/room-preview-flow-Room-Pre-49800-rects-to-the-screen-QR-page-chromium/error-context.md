...
- Name: room-preview-flow.spec.ts >> Room Preview — screen launcher >> creates a session and redirects to the screen/QR page
- Location: tests\e2e\room-preview-flow.spec.ts:25:7
